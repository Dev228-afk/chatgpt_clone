...
const gpt_image = `<img src="${url_prefix}/assets/img/clipart-sharing-pencil-4.jpg" alt="GPT Avatar">`;
let prompt_lock = false;
document.body.background = "url('/client/img/clipart-sharing-pencil-4.jpg')";
...
// hljs.addPlugin(new CopyButtonPlugin());
// document.body.style.backgroundImage = "url('/client/img/clipart-sharing-pencil-4.jpg')";
...
// const load_gpt_message_box = (content) => {
//   // content = content ;
//   // message returned from past conversations (from local storage)
//   return `
//             <div class="message">
//                 <div class="avatar-container">
//                     ${gpt_image}
